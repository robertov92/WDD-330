...
function keyDown( /** @type {KeyboardEvent} */ ev) {
    ...
    switch (ev.keyCode) {
        ...
        case 39: // right arrow (rotate ship right)
            ship.rot = -SHIP_TURN_SPD / 180 * Math.PI / FPS;
            //roids[0].rotation = SHIP_TURN_SPD / 180 * Math.PI / FPS;
            //console.log(roids[0].rotation)
            break;
    }
}
...
function Sound(src, maxStrams = 1, vol = 1.0) {
    ...
    this.play = function() {
        this.streamNum = (this.streamNum + 1) % maxStrams;
